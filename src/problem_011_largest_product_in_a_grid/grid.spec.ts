...
describe('problem 11: grid', () => {
  ...
  beforeEach(() => {
    grid = Grid.parse(rawGrid);
  });

  xit('parses raw grid to two dimensional number array', () => {
  ...
  xit('gets columns from parsed rows - a diagonal mirror of array', () => {
    const columns = grid.columns();
    expect(columns.columns()).to.deep.equal(grid);
